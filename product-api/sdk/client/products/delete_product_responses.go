...
func (o *DeleteProductCreated) Error() string {
	return fmt.Sprintf("[DELETE /products][%d] deleteProductCreated ", 201)
}
...
func (o *DeleteProductNotFound) Error() string {
	return fmt.Sprintf("[DELETE /products][%d] deleteProductNotFound  %+v", 404, o.Payload)
}
func (o *DeleteProductNotFound) GetPayload() models.H {
	return o.Payload
}
...
func (o *DeleteProductNotImplemented) Error() string {
	return fmt.Sprintf("[DELETE /products][%d] deleteProductNotImplemented  %+v", 501, o.Payload)
}
func (o *DeleteProductNotImplemented) GetPayload() models.H {
	return o.Payload
}
